...
{     
    ...
    */
    int a = 0,b=1,c=2;
        pthread_create(&pthread_id[0],NULL,thread_worker,(void*)&a);
        pthread_create(&pthread_id[1],NULL,thread_worker,(void*)&b);
        pthread_create(&pthread_id[2],NULL,thread_worker,(void*)&c);
